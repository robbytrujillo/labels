    ...
    <div class="container mt-4 main-content">
        ...
        <div class="card shadow-sm p-3 mb-3">
            <h6 class="fw-bold mb-3">
                <i class="bi bi-printer"></i> Print Label Per Kelas
            </h6>

            <div class="kelas-print-grid">
                <?php while($k = $kelasList->fetch_assoc()): ?>
                <a href="modules/siswa/pdf_kelas.php?kelas=<?= urlencode($k['kelas']) ?>" target="_blank"
                    class="btn btn-outline-dark btn-sm">
                    <i class="bi bi-file-earmark-pdf"></i> <?= htmlspecialchars($k['kelas']) ?>
                </a>
                <?php endwhile; ?>
            </div>
        </div>
